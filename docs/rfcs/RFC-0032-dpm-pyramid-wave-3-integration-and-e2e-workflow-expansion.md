...
3. E2E workflow paths for support-bundle optional sections, lineage filters, and workflow decision listing.
...
1. Extend integration suites under `tests/integration/dpm/api`.
