...
lifecycle controls and lifecycle-event projection added as bounded audit posture. Global campaign
discovery, approval state mutation, maker-checker workflow, richer campaign operating queues, and external
execution remain explicit future scope, not hidden defects in the supported wave path.
