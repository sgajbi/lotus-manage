...
immutable `wave_json` body for the current manage backend implementation. An automatic CIO
model-change impact table is not implemented because automatic CIO model-change cohort discovery
remains deferred with no supported-feature claim.
