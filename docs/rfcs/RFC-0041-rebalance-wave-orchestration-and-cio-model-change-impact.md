...
projection added as read-only cross-actor operating posture. Global campaign discovery, approval
state mutation, maker-checker workflow, richer assignment/escalation workflow beyond the read-only
board, and external execution remain explicit future scope, not hidden defects in the supported
wave path.
