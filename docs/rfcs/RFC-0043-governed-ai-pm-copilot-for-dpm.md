...
7. `lotus-ai` PR #68 implements the owner-side DPM exception summary pack over bounded
   monitoring-exception evidence and optional portfolio-memory context; full copilot workspace,
   autonomous advice, and product-surface execution remain unsupported.
