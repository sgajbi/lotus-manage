...
| RFC-0040 | Pre-Trade Proof Pack and DPM Evidence Fabric | IN PROGRESS (SLICES 0-4 COMPLETE; MARKDOWN SUMMARY IMPLEMENTED) | RFC-0017, RFC-0019, RFC-0020, RFC-0021, RFC-0023, RFC-0036, RFC-0037, RFC-0038, RFC-0039 | `docs/rfcs/RFC-0040-pre-trade-proof-pack-and-evidence-fabric.md` |
