...
2. PM operating quality now has a bounded Manage-owned policy administration, score-run preview,
   ...
   PM-book scope materialization, bounded portfolio-memory score-run lineage projection, and
   source-defined segment fairness spread posture without protected-class inference or PM ranking;
   downstream UI remains future expansion,
