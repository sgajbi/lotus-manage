...
| 2 | RFC41-WTBD-003 - Tactical house-view, risk-event, and campaign/bulk-review cohorts | Moves the rebalance wave operating model toward bank operating workflows without inventing source-owned cohorts. Risk-event source ownership, bounded manage consumption, Advise-owned tactical house-view source ownership, bounded Manage tactical house-view consumption, first-wave Manage-owned bulk-review campaign membership with optional governance evidence, immutable Manage-owned campaign definitions over source-backed candidate sets, and Gateway campaign-definition BFF composition are now implemented. | Global discovery and downstream Workbench campaign product UI are added only after source behavior and product evidence are proven. |
...
5. supported separately: risk-event and tactical house-view waves through their owning source
   products,
6. unsupported: global campaign discovery, downstream Workbench campaign UI, permission-denied, and
   stale-book cohort semantics until owning source products exist,
...
5. supported separately: risk-event and tactical house-view waves through their owning source
   products,
6. unsupported: global campaign discovery, downstream Workbench campaign UI, permission-denied,
   stale-cohort, external OMS execution, and richer campaign product rendering until owning slices
...
The broader WTBD remains partial because global campaign discovery and downstream Workbench
campaign UI remain future depth. `lotus-gateway` PR #212 now composes the manage-owned
...
Future campaign depth should expand the now-promoted manage-owned membership envelope with global
discovery and Workbench product-surface behavior only after those controls are proven.
...
6. Workbench campaign UI consumes Gateway campaign-definition BFF routes only,
...
campaign-definition list/get/upsert; future slices should add global discovery and Workbench
product surfaces without moving source-fact ownership into Manage or Gateway.
...
| Debt removed | Previous RFC/wiki wording stopped at the source-owner foundation and left manage consumption as a future claim. This slice removes that drift while keeping global campaign discovery and downstream Workbench campaign UI explicitly unpromoted. |
...
| Expected-standard decision | This reaches the backend standard for bounded governance evidence on Manage-owned campaign membership. Tactical house-view is supported separately through the Advise source product, persisted campaign definitions are supported in Manage, and Gateway campaign-definition BFF composition is supported through `lotus-gateway` PR #212. Global campaign discovery, downstream Workbench campaign UI, and OMS execution remain outside the support claim. |
...
This completion does not promote global campaign discovery, downstream Workbench campaign UI, or
