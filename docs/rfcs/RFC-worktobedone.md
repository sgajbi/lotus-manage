...
persisted campaign discovery, a bounded workflow-overview read model, and Gateway BFF composition
for campaign-definition list/get/upsert plus Workbench active list rendering; future slices should
add global portfolio-universe discovery, approval inboxes, maker-checker workflow, and richer
campaign operating queues without moving source-fact ownership into Manage, Gateway, or Workbench.
