...
approval-decision evidence, a bounded operating queue, a bounded approval-attention inbox, and
...
decisions, and broader cross-actor campaign operating queues without moving source-fact ownership
into Manage, Gateway, or Workbench.
