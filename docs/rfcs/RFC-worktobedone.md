...
59 total WTBD items: 54 done on merged/published Lotus-owned truth, 4 partial or in progress, and
...
Gateway-only facets and applied filters. This does not move counts because RFC40-WTBD-010 was
already complete for current Manage-backed portfolio-memory support and RFC42-WTBD-006 remains
partial for source-owner methodology depth beyond the represented lineage search posture.
...
| Done on merged/published Lotus-owned truth | 54 | Implementation-backed Lotus-owned items merged to owning `main` branches, validated, and published where wiki truth changed; external bank-system promotion dependencies remain explicit non-claims. |
| Partial / in progress | 4 | Items with meaningful implementation-backed progress but remaining Lotus-owned source, Manage, downstream, methodology, or product-surface gaps. |
