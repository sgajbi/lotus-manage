...
59 total WTBD items: 53 done on merged/published Lotus-owned truth, 5 partial or in progress, and
...
| Done on merged/published Lotus-owned truth | 53 | Implementation-backed Lotus-owned items merged to owning `main` branches, validated, and published where wiki truth changed; external bank-system promotion dependencies remain explicit non-claims. |
| Partial / in progress | 5 | Items with meaningful implementation-backed progress but remaining Lotus-owned source, Manage, downstream, methodology, or product-surface gaps. |
