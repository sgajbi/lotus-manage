...
| 2 | RFC41-WTBD-003 - Tactical house-view, risk-event, and campaign/bulk-review cohorts | Moves the rebalance wave operating model toward bank operating workflows without inventing source-owned cohorts. Risk-event source ownership, bounded manage consumption, Advise-owned tactical house-view source ownership, bounded Manage tactical house-view consumption, first-wave Manage-owned bulk-review campaign membership with optional governance evidence, and immutable Manage-owned campaign definitions over source-backed candidate sets are now implemented. | Global discovery and downstream campaign product surfaces are added only after source behavior and product evidence are proven. |
...
5. supported separately: risk-event and tactical house-view waves through their owning source
   products,
...
6. unsupported: global campaign discovery, permission-denied, stale-cohort, external OMS execution,
   and downstream campaign product rendering until owning slices implement and prove those paths.
...
The broader WTBD remains partial because global campaign discovery and downstream campaign product
surfaces remain future depth. Future campaign depth should expand the now-promoted manage-owned
membership envelope with global discovery and downstream product-surface behavior only after those
controls are proven.
...
6. manage validates supportability without calculating underlying source facts locally.
...
governance evidence, and immutable persisted campaign definitions; future slices should add global
discovery and downstream product surfaces without moving source-fact ownership into Manage.
...
| Debt removed | Previous RFC/wiki wording stopped at the source-owner foundation and left manage consumption as a future claim. This slice removes that drift while keeping global campaign discovery and downstream campaign product surfaces explicitly unpromoted. |
...
| Expected-standard decision | This reaches the backend standard for bounded governance evidence on Manage-owned campaign membership. Tactical house-view is supported separately through the Advise source product, and persisted campaign definitions are supported in Manage. Global campaign discovery, downstream Gateway/Workbench campaign UI, and OMS execution remain outside the support claim. |
...
This completion does not promote global campaign discovery, downstream campaign product surfaces,
or external OMS execution. Those remain separate source-owner, downstream-product, or
