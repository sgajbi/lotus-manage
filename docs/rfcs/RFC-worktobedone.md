...
owner dependencies remain explicit in the row and do not become hidden support claims. WTBDs with
...
59 total WTBD items: 48 done on merged/published Lotus-owned truth, 7 partial or in progress, and
4 remaining/open. The 2026-05-22 Lotus-owned completion recount moves RFC38-WTBD-007,
...
external-owner promotion dependencies, not blockers for Lotus-owned WTBD completion. Later
cross-repo review
