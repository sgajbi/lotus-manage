...
universe, recalculate source facts, create approval inboxes, run maker-checker workflow, approve
...
and Gateway BFF composition
for campaign-definition list/get/upsert plus Workbench active list rendering; future slices should
add global portfolio-universe discovery, approval inboxes, maker-checker workflow, and broader
cross-actor campaign operating queues without moving source-fact ownership into Manage, Gateway, or
Workbench.
