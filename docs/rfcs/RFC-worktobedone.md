...
lifecycle controls, bounded persisted campaign discovery, and Gateway BFF composition for
campaign-definition list/get/upsert plus Workbench active list rendering; future slices should add
global portfolio-universe discovery and broader campaign workflow surfaces without moving
