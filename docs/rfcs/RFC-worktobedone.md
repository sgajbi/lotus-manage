...
persisted campaign discovery, a bounded workflow-overview read model, a bounded operating queue,
a bounded approval-attention inbox, and Gateway BFF composition
for campaign-definition list/get/upsert plus Workbench active list rendering; future slices should
add global portfolio-universe discovery, approval state mutation, maker-checker workflow, and
broader cross-actor campaign operating queues without moving source-fact ownership into Manage,
Gateway, or Workbench.
