...
This advances RFC39-WTBD-008 from planned Lotus-side source-contract boundary to a first fail-closed runtime source-owner posture. It does not certify an external treasury ingestion table,
expose a Manage adapter, or add hedge advice, forward pricing, treasury instruction, counterparty
selection, best execution, OMS acknowledgement, fills, settlement, or autonomous treasury action.
