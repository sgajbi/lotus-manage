...
| 2 | RFC41-WTBD-003 - Tactical house-view, risk-event, and campaign/bulk-review cohorts | Moves the rebalance wave operating model toward bank operating workflows without inventing source-owned cohorts. Risk-event source ownership, bounded manage consumption, Advise-owned tactical house-view source ownership, bounded Manage tactical house-view consumption, first-wave Manage-owned bulk-review campaign membership with optional governance evidence, immutable Manage-owned campaign definitions over source-backed candidate sets, fail-closed campaign-definition preview readiness, bounded campaign-definition launch packages, Gateway campaign-definition BFF composition, and Workbench active campaign-definition list rendering are now implemented. | Global discovery and broader campaign workflow surfaces are added only after source behavior and product evidence are proven. |
...
launch-package request drafts, bounded persisted campaign discovery, and Gateway BFF composition
for campaign-definition list/get/upsert plus Workbench active list
