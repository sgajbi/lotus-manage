...
2. `lotus-manage-products.v1.json`
   ...
   sgajbi/lotus-manage#624. Source-owned Risk/Performance mandate-health `as_of_date` metadata is
   now preserved when producers supply it; older, missing, or mixed source evidence remains
   non-certifying. The not-certified
