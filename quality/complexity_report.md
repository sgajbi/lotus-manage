...
- Generated at: `2026-06-13T11:51:19+00:00`

- Report source snapshot: `f99c9bc2+worktree`
...
| Rank | Function | File | Complexity | Lines |
| --- | --- | --- | --- | --- |
| 1 | build_run_filter_query | src/infrastructure/rebalance_runs/run_query.py | 7 | 38 |
| 2 | _example_from_schema | src/api/openapi_enrichment.py | 7 | 37 |
| 3 | _ensure_operation_examples | src/api/openapi_enrichment.py | 7 | 33 |
| 4 | _risk_context_from_concentration_response | src/infrastructure/risk_authority/client.py | 7 | 33 |
| 5 | _apply_single_position_max_weight | src/core/rebalance/targets.py | 7 | 31 |
| 6 | purge_mandate_records_before | src/infrastructure/mandates/in_memory.py | 7 | 31 |
| 7 | build_bulk_review_campaign_definition_assignment_action_page | src/core/waves/campaign_assignment_actions.py | 7 | 27 |
| 8 | save_proof_pack | src/infrastructure/proof_packs/in_memory.py | 7 | 24 |
| 9 | _resolve_handoff | src/core/outcomes/snapshots.py | 7 | 23 |
| 10 | _analytics_source_ref | src/core/waves/source_analytics.py | 7 | 22 |
