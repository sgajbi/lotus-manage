...
- Generated at: `2026-06-19T05:14:01+00:00`

- Report source snapshot: `34c8d949+worktree`
...
| Rank | Function | File | Complexity | Lines |
| --- | --- | --- | --- | --- |
| 1 | authorize_write_request | src/api/enterprise_readiness.py | 6 | 19 |
| 2 | _schema_type_example | src/api/openapi_enrichment.py | 6 | 19 |
| 3 | currency_overlay_status | src/api/services/construction_currency_overlay_supportability.py | 6 | 19 |
| 4 | iter_changed_fields | src/api/services/mandate_diff.py | 6 | 19 |
| 5 | ready_optional_source | src/api/services/mandate_optional_sources.py | 6 | 19 |
| 6 | _historical_attribution_set | src/core/outcomes/risk_sources.py | 6 | 19 |
| 7 | _validate_portfolio_memory_event_aggregates | src/core/portfolio_memory/models.py | 6 | 19 |
| 8 | _proof_pack_id | src/core/proof_packs/builder.py | 6 | 19 |
| 9 | bulk_review_campaign_definition_hash | src/core/waves/campaign_definitions.py | 6 | 19 |
| 10 | list_waves | src/infrastructure/waves/in_memory.py | 6 | 19 |
