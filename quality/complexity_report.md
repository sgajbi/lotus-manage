...
- Generated at: `2026-06-19T05:22:10+00:00`

- Report source snapshot: `8bea3d52+worktree`
...
| Rank | Function | File | Complexity | Lines |
| --- | --- | --- | --- | --- |
| 1 | iter_changed_fields | src/api/services/mandate_diff.py | 6 | 19 |
| 2 | ready_optional_source | src/api/services/mandate_optional_sources.py | 6 | 19 |
| 3 | _historical_attribution_set | src/core/outcomes/risk_sources.py | 6 | 19 |
| 4 | _validate_portfolio_memory_event_aggregates | src/core/portfolio_memory/models.py | 6 | 19 |
| 5 | _proof_pack_id | src/core/proof_packs/builder.py | 6 | 19 |
| 6 | bulk_review_campaign_definition_hash | src/core/waves/campaign_definitions.py | 6 | 19 |
| 7 | list_waves | src/infrastructure/waves/in_memory.py | 6 | 19 |
| 8 | _validate_empty_search_item_latest_event_metadata | src/core/portfolio_memory/models.py | 6 | 18 |
| 9 | _performance_source_posture | src/core/outcomes/performance_sources.py | 6 | 17 |
| 10 | _risk_source_posture | src/core/outcomes/risk_sources.py | 6 | 17 |
