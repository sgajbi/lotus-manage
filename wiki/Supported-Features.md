...
| Advanced construction alternatives | RFC-0039 | Proposed implementation-ready manage capability. Promote only after persisted comparable alternatives, objective/constraint traces, solver/fallback posture, canonical live proof, and paired Gateway/Workbench realization RFCs are complete. |
