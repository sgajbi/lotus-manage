...
tracks 59 WTBD items: 20 done on merged/published truth, 3 partial or in progress, and 36 remaining
...
| ---: | --- | --- | --- |
| 1 | RFC41-WTBD-006 - Workbench wave command center | Creates a PM operating cockpit for explicit portfolio-list waves now that Gateway wave composition is merged and wiki-published. | Workbench UX, browser proof, canonical screenshots, operations/sales/client-demo wiki material. |
| 2 | RFC40-WTBD-004 - Report materialization from proof-pack report input | Turns proof-pack report-input handoff into generated evidence documents. | Report/render/archive implementation, supportability, and demo-ready wiki proof in owning repos. |
...
| CIO model-change and full front-office rebalance waves | RFC-0041, Gateway RFC-0098, Workbench RFC-0098 | Manage backend support is implementation-backed and closed as `DONE` for explicit portfolio-list waves. Gateway wave composition is implementation-backed and wiki-published through `lotus-gateway` PR #196. Automatic PM-book/CIO model-change cohort discovery and Workbench wave command-center product support remain deferred until source-owning products, Workbench implementation, and canonical browser evidence are complete. |
