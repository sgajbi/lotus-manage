...
| Pre-trade proof packs | Manage owns durable proof-pack JSON, Markdown, report input, AI evidence input, hashes, lineage, and supportability states; Gateway composes proof-pack BFF truth; Workbench renders the first-wave proof-pack review panel. | First-wave PM/CIO review UX is implementation-backed. Full canonical product realization, report materialization, and governed AI memo generation remain separate WTBD priorities. |
...
tracks 59 WTBD items: 18 done on merged/published truth, 3 partial or in progress, and 38 remaining
...
| ---: | --- | --- | --- |
| 1 | RFC40-WTBD-003 - Full proof-pack product realization | Converts manage backend proof-pack authority into a bank-ready front-office product claim. | Gateway and Workbench proof-pack slices merged, canonical front-office QA green, audience-ready docs/wiki. |
| 2 | RFC41-WTBD-005 - Gateway wave composition | Exposes explicit rebalance-wave authority without making Gateway the workflow owner. | Gateway route, contract, supportability, and no-reconstruction tests. |
| 3 | RFC41-WTBD-006 - Workbench wave command center | Creates a PM operating cockpit for explicit portfolio-list waves. | Workbench UX, browser proof, canonical screenshots, operations/sales/client-demo wiki material. |
| 4 | RFC40-WTBD-004 - Report materialization from proof-pack report input | Turns proof-pack report-input handoff into generated evidence documents. | Report/render/archive implementation, supportability, and demo-ready wiki proof in owning repos. |
...
| Full front-office proof-pack review | RFC-0040, Gateway RFC-0098, Workbench RFC-0098 | Manage backend proof-pack authority, Gateway proof-pack composition, and the first-wave Workbench proof-pack review panel are supported. Promote the full proof-pack product outcome only after canonical front-office proof, report materialization posture, AI memo posture, and client-demo documentation are implemented and validated in the owning apps. |
