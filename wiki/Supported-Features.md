...
| Explicit portfolio-list waves | Manage owns explicit wave preview/create/source-check/simulate/select/approve/stage/handoff, report-input, and supportability; Gateway composes the command-center BFF; Workbench renders the first-wave Rebalance Wave Command Center for the canonical portfolio; report/render/archive materialize governed rebalance-wave reports from manage report input. | First-wave PM operating cockpit and governed wave report lifecycle are implementation-backed, CI-proven, live-proven where product-surfaced, and wiki-published. Automatic PM-book/CIO/risk-event cohort discovery, owning-service risk/performance enrichment, AI memo generation from wave evidence, and external OMS execution remain future WTBDs. |
...
| CIO model-change and full front-office rebalance waves | RFC-0041, Gateway RFC-0098, Workbench RFC-0098 | Manage backend support is implementation-backed and closed as `DONE` for explicit portfolio-list waves. Gateway wave composition, first-wave Workbench wave command center support, and governed rebalance-wave report materialization in report/render/archive are implementation-backed, live-proven or CI-proven as applicable, and wiki-published. Automatic PM-book/CIO model-change/risk-event cohort discovery, AI memo generation from wave evidence, and external OMS execution remain deferred until source-owning products and owning-service implementations are complete. |
