...
`ExternalHedgeExecutionReadiness:v1` as an active fail-closed `UNAVAILABLE` route. Manage does not
consume it yet and still makes no hedge advice, forward-pricing, counterparty-selection,
best-execution, treasury-instruction, OMS, fills, or settlement claim.
