...
| RFC-0043 | AI assists PM productivity without owning investment truth. | Owner-side `lotus-ai` DPM workflow packs now cover proof-pack PM memo, wave PM memo, outcome-review narrative, operations handoff summary, conservative default-version resolution, forbidden-action/output guardrails, no-raw-payload posture, review-required output, and no-sensitive telemetry boundaries. Exception support, full copilot workspace, and Gateway/Workbench operations-handoff invocation remain future owner work. |
