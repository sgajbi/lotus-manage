...
| RFC-0040 | PMs, compliance, operations, CIO, and audit can inspect one pre-trade evidence artifact. | Manage-owned durable proof-pack JSON, Markdown summary, report-input and AI-evidence input contracts, lineage and retention posture, and Gateway/Workbench realization RFC alignment. Full front-office product support waits for downstream implementation and canonical live proof. |
