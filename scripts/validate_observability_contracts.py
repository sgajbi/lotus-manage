...
def implemented_metric_contract() -> dict[str, tuple[str, ...]]:
    return {
        ...
        f"{observability.CAMPAIGN_WORKFLOW_TOTAL._name}_total": tuple(
            observability.CAMPAIGN_WORKFLOW_TOTAL._labelnames
        ),
        f"{observability.CAMPAIGN_READ_MODEL_SCAN_TOTAL._name}_total": tuple(
            observability.CAMPAIGN_READ_MODEL_SCAN_TOTAL._labelnames
        ),
