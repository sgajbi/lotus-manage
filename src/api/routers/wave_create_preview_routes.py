    ...
    *,
    ...
    @router.post(
        ...
        description=(
            ...
            "source-backed candidate portfolios only when candidate refs satisfy approved "
            "source-contract, READY supportability, version, and hash rules, or from lotus-core "
    ...
    @router.post(
        ...
        description=(
            ...
            "lotus-core `DpmPortfolioUniverseCandidate:v1` source-backed candidates; inline and "
            "persisted candidates must carry approved source-contract refs with READY posture, "
            "source version, and required content hashes. Core "
