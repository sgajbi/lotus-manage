...
def _supportability_response(
    ...
    return DpmOutcomeReviewSupportabilityResponse(
        ...
        external_execution_boundary=_external_execution_boundary(review),
    )
...
def _external_execution_boundary(
    ...
    acknowledgement_count = _execution_acknowledgement_count(reason_codes)
    ...
    payload = {
        ...
        "execution_acknowledgement_count_projected": acknowledgement_count,
        "reason_code": (
